...
def convert_temperature(temperature, unit):
  if unit == 'C':
    convert_celsius = (temperature * 9/5) + 32
    return f'{int(convert_celsius)}°F'
  if unit == 'F':
    convert_fahrenheit = (temperature - 32) * 5/9
    return f"{int(convert_fahrenheit)}°C"
...
def calculate_tip(bill_amount, tip_percentage):
  tip_calculated = bill_amount * tip_percentage / 100
  return f"${int(tip_calculated)}"
...
print('Exercise 8:', product(1, 2, 3))
...
print('Exercise 9 Result:', basic_calculator(10, 5, "*"))
